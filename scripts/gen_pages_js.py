"""Generate pages.js for MarinerX Labs Phase 15 UI."""
from pathlib import Path

OUT = Path(__file__).resolve().parents[1] / "src/mcc/interface/web/static/pages.js"

HEADER = """/* MarinerX Labs Phase 15 — Page Templates */
window.PAGES = {};
...
# Additional pages - write as strings and concatenate
INDICATORS = """
...
content = HEADER + HOME + MARKET_PULSE + INDICATORS + STRATEGY + VALIDATION + RESEARCH + RISK + DECISION + EXECUTION + JOURNAL + PERFORMANCE + REPORTS + SETTINGS
